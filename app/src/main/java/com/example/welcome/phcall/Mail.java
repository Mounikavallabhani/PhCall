package com.example.welcome.phcall;
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(to.isEmpty()){
                        Toast.makeText(Mail.this, "You must enter a recipient email", Toast.LENGTH_LONG).show();
                    }else if(subject.isEmpty()){
                        Toast.makeText(Mail.this, "You must enter a Subject", Toast.LENGTH_LONG).show();
                    }else if(message.isEmpty()){
                        Toast.makeText(Mail.this, "You must enter a message", Toast.LENGTH_LONG).show();
                    }else {
