...
/**
 * Created by Welcome on 4/5/2018.
 */

public class SimpleMail {
    private static final String SMTP_HOST_NAME = "smtp.gmail.com"; //can be your host server smtp@yourdomain.com
    private static final String SMTP_AUTH_USER = "someone@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "secret"; //password/secret
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        String from = "fromemail@gmail.com"; //from
